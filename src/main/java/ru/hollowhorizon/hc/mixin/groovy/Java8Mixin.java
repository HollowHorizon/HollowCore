...
public abstract class Java8Mixin {
    ...
    public void configureClassNode(final CompileUnit compileUnit, final ClassNode classNode) {
        try {
            ...
            Map<String, String> deobfFields = !FMLEnvironment.production ? null : GroovyDeobfMapper.getDeobfFields(clazz);
            ...
            Map<String, String> deobfMethods = !FMLEnvironment.production ? null : GroovyDeobfMapper.getDeobfMethods(clazz);
