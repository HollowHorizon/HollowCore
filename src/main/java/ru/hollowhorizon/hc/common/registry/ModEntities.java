...
public class ModEntities {
    @HollowRegister(model = "hc:models/mmd/player_test.zip")
    public static final EntityType<TestEntity> player = createEntity(
            TestEntity::new,
            EntityClassification.CREATURE, 1F, 2F, "player"
    );

    @HollowRegister(model = "hc:models/mmd/rem.zip")
