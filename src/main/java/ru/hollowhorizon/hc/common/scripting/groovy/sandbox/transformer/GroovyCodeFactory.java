package ru.hollowhorizon.hc.common.scripting.sandbox.transformer;

import net.minecraftforge.fml.loading.FMLEnvironment;
import org.codehaus.groovy.ast.ClassNode;
import org.codehaus.groovy.ast.MethodNode;
import org.codehaus.groovy.reflection.*;
import ru.hollowhorizon.hc.common.scripting.groovy.sandbox.api.GroovyBlacklist;
...
public class GroovyCodeFactory {
    ...
    public static PrivilegedAction<CachedField[]> makeFieldsHook(CachedClass cachedClass) {
        return () -> Arrays.stream(cachedClass.getTheClass().getDeclaredFields())
                ...
                .map(FMLEnvironment.production && cachedClass.getName().startsWith(MC_CLASS) ?
                        f -> makeField(cachedClass, f) : CachedField::new)
