...
public class HollowFontRenderer extends HollowFont {
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow, float kerning) {
        ...
        GlStateManager._color4f((float) (color >> 16 & 255) / 255f, (float) (color >> 8 & 255) / 255f, (float) (color & 255) / 255f, alpha);
        GlStateManager._enableTexture();
        GlStateManager._bindTexture(this.tex.getId());
        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (character == '\u00a7') {
                ...
                if (colorIndex < 16) {
                    ...
                    GlStateManager._color4f((float) (colorcode >> 16 & 255) / 255f, (float) (colorcode >> 8 & 255) / 255f, (float) (colorcode & 255) / 255f, alpha);
                    ...
                    if (italic) {
                        GlStateManager._bindTexture(this.texItalicBold.getId());
                        currentData = this.boldItalicChars;
                    } else {
                        GlStateManager._bindTexture(this.texBold.getId());
                    ...
                    if (bold) {
                        ...
                        GlStateManager._bindTexture(this.texItalic.getId());
