...
public class RenderedGltfScene {
    ...
    public void renderForVanilla() {
        ...
        FloatBuffer buffer0 = RenderedGltfModel.CURRENT_SHADER_INSTANCE.LIGHT0_DIRECTION.getFloatBuffer();
        FloatBuffer buffer1 = RenderedGltfModel.CURRENT_SHADER_INSTANCE.LIGHT1_DIRECTION.getFloatBuffer();
        RenderedGltfModel.LIGHT0_DIRECTION = new Vector3f(buffer0.get(0), buffer0.get(1), buffer0.get(2));
        RenderedGltfModel.LIGHT1_DIRECTION = new Vector3f(buffer1.get(0), buffer1.get(1), buffer1.get(2));
    ...
    public void renderForShaderMod() {
        ...
        Matrix4f inv = projectionMatrix.copy();
        inv.invert();
        inv.store(RenderedGltfModel.BUF_FLOAT_16);
