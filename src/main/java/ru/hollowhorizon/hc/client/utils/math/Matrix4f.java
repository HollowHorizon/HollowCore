...
public class Matrix4f extends Matrix<Matrix4f> implements Serializable {
    ...
    public Matrix4f(net.minecraft.util.math.vector.Matrix4f src) {
        super();
        load(src);
    }
    ...
    public static Matrix4f load(net.minecraft.util.math.vector.Matrix4f src, Matrix4f dest) {
        if (dest == null)
            dest = new Matrix4f();
        dest.m00 = src.m00;
        dest.m01 = src.m01;
    ...
    public Matrix4f load(net.minecraft.util.math.vector.Matrix4f src) {
        return load(src, this);
    }
