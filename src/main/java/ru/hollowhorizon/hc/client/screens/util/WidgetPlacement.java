...
public class WidgetPlacement {
    ...
    public static <T extends Widget> T configureWidget(IWidgetConsumer<T> widget, Alignment alignment, int offsetX, int offsetY, int positionWidth, int positionHeight, int targetWidth, int targetHeight) {
        return configureWidget(widget, alignment, offsetX, offsetY, positionWidth, positionHeight, targetWidth, targetHeight, 1.0F);
    }

    public static <T extends Widget> T configureWidget(IWidgetConsumer<T> widget, Alignment alignment, int offsetX, int offsetY, int positionWidth, int positionHeight, int targetWidth, int targetHeight, float size) {
