...
interface ILayer {
    ...
    fun compute(node: GltfTree.Node, target: AnimationTarget, partialTick: Float): FloatArray?
...
class AnimationLayer(
    ...
    override fun compute(node: GltfTree.Node, target: AnimationTarget, partialTick: Float) =
...
class SmoothLayer(
    ...
    override fun compute(node: GltfTree.Node, target: AnimationTarget, partialTick: Float): FloatArray? {
...
class HeadLayer(var animatable: LivingEntity, override var priority: Float) : ILayer {
    ...
    fun isValidNode(node: GltfTree.Node?): Boolean {
